...
const sendListTx = async ({
  ...
  try {
    const baseUrl = "https://api-devnet.magiceden.dev/v2/instructions/deposit";
    const endpointUrl = `${baseUrl}?buyer=${buyerAddress}&amount=${amount}&auctionHouseAddress=${auctionHouseAddress}`;
